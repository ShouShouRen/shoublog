...
tags: Vue2+Vue3
keywords: shoublog shouren 瘦瘦仁的前端部落 Vue Vue2 Vue3 Vue2+Vue3
---
    ...
    const app = new Vue({
      ...
      methods: {
        remove(index) {
          ...
          // 第三次比較：工作項目的 id 是 4，與要刪除的工作的 id 2 不相同，所以條件是 true，這個工作項目會被保留。
          // 第三次比較：工作項目的 id 是 5，與要刪除的工作的 id 2 不相同，所以條件是 true，這個工作項目會被保留。
